...
/**
 * Manages "Authentication" to CodeFind's backend service.  The SyncAdapter framework
 ...
 */
public class CodeFindAuthenticator extends AbstractAccountAuthenticator {

    public CodeFindAuthenticator(Context context) {
        super(context);
    }
